...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcc}
    ...
    Neural Demand (CF) & $0.00317 \pm 0.00060$ & $0.00322 \pm 0.00053$ \\
    Neural Demand (habit) & {---} & {---} \\
    Neural Demand (habit, CF) & $0.00647 \pm 0.00063$ & $0.00425 \pm 0.00012$ \\
    \bottomrule
  \end{tabular}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcc}
    ...
    Neural Demand (CF) & $0.02651 \pm 0.00087$ & $0.02752 \pm 0.00018$ \\
    Neural Demand (habit) & {---} & {---} \\
    Neural Demand (habit, CF) & $0.02134 \pm 0.00039$ & $0.02337 \pm 0.00130$ \\
    \bottomrule
  \end{tabular}
  \begin{tablenotes}\small
    \item RMSE evaluated against structural (IV-purged) demand at test prices.
